...
public class UnoGameTest extends junit.framework.TestCase
{
    ...
    public void testDealCards() {
        ...
        assertEquals(7, player0.getCards().size());
        assertEquals(7, player1.getCards().size());
        assertEquals(21, game.getDeck().size());
        assertEquals(1, game.getPile().size());
    ...
    public void testPlayTurn() {
        ...
        deck.add(cards[Card.COLOUR_YELLOW][3]);
        deck.add(cards[Card.COLOUR_YELLOW][4]);
        ...
        deck.add(cards[Card.COLOUR_BLUE][1]);
        deck.add(cards[Card.COLOUR_YELLOW][4]);
    ...
    public void testPlay() {
        ...
        deck.add(cards[Card.COLOUR_BLUE][6]);
        deck.add(cards[Card.COLOUR_YELLOW][7]);
        deck.add(cards[Card.COLOUR_RED][3]);
        deck.add(cards[Card.COLOUR_GREEN][8]);
