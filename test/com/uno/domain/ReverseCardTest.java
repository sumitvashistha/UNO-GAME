...
public class ReverseCardTest extends junit.framework.TestCase
{
    ...
    public void testPlay()   {
        ...
        deck.add(new Card(Card.COLOUR_RED, 6));
        deck.add(new Card(Card.COLOUR_RED, 2));
        deck.add(new Card(Card.COLOUR_YELLOW, 3));
        deck.add(new Card(Card.COLOUR_RED, 6));
        deck.add(new Card(Card.COLOUR_YELLOW, 8));
        deck.add(new Card(Card.COLOUR_RED, 9));
        deck.add(new Card(Card.COLOUR_YELLOW, 1));
